<?php
    ...
    $to  = 'ccss.sio@gmail.com, csio@tastradesoft.com, rsabanal@tastradesoft.com, charina10181990@gmail.com';
    ...
    $message = '<html>
                        ...
                        if($positionsTruck!=null) {
                            $message.='<table>
                                ...
                                foreach ($positionsTruck as $value) {
                                    ...
                                    $message.='</td>';
                                    $message.="<td><a href='http://arka.tastradedev.com/includes/damages/trucks/".strtolower($positions[$value])."/$gateLogID.jpg' target='_blank'><img src='http://arka.tastradedev.com/includes/damages/trucks/".strtolower($positions[$value])."/$gateLogID.jpg' width='100'></a></td></tr>";
                                }
                        ...
                        if($positionsTrailer!=null) {
                            $message.='<br/><table>
                                ...
                                foreach ($positionsTrailer as $value) {
                                    ...
                                    $message.='</td>';
                                    $message.="<td><a href='http://arka.tastradedev.com/includes/damages/trailers/".strtolower($positions[$value])."/$gateLogID.jpg' target='_blank'><img src='http://arka.tastradedev.com/includes/damages/trailers/".strtolower($positions[$value])."/$gateLogID.jpg' width='100'></a></td></tr>";
                                }
         ...
         $headers .= 'To: Admin <csio@tastradesoft.com>, Shop Manager <ccss.sio@gmail.com> , Shop Manager <csio@tastradesoft.com>' . "\r\n";
