                            ...
                            <tr>
                                ...
                                <?php foreach ($fields as $field_name => $field_display): ?>
                                    <th <?php if ($order_column == $field_name) echo "class=sort_$order_type " ?>>
                                        <?php echo anchor('trailer/view/'.$search.'/'.$limit.'/'.$field_name.'/'.
                        ...
                        <tbody>
							<?php foreach ($view_data as $key => $data): ?>
							  <tr>
                                ...
                                <?php endforeach; ?>
								<td>
                                    <button type="button" data-qr-title="<?php echo 'Trailer Number - '.$data['T_Number']; ?>" class="btn btn-primary btn-sm qr-code-context" title="view QR code" data-qr-url="http://api.qrserver.com/v1/create-qr-code/?data=<?php echo 'Trailer-'.$data['T_ID']; ?>&size=100x100">
                                        <span class="glyphicon glyphicon-qrcode"></span> 
                                    </button>
                                </td>
                                <td>
                                    <button type="button" class="btn btn-link btn-sm edit-user-context" title="edit" data-edit-user="<?php echo base_url().$class.'/edit/'.$data['T_ID'];?>">
                                        <span class="glyphicon glyphicon-cog"></span>
                                    </button>
                                    <button type="submit" class="btn btn-link btn-sm delete-user-btn" title="delete" data-delete-user="<?php echo base_url().$class.'/delete/'.$data['T_ID'];?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <button type="button" class="btn btn-default btn-lg right" id="add-user" data-edit-user="<?php echo base_url().$class.'/edit/';?>">
                                <span class="glyphicon glyphicon-plus"></span> add trailer
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="container-fluid">
                    <div class="panel panel-popup">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-xs-6">
                                    <div class="title">TRAILER QR CODE</div>
                                </div>
                                <div class="col-xs-6">
                                </div>
                            </div>
